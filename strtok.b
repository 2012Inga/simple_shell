 ...
 */
char **
splitString (const char *input, const char *delimiter, int *count)
{
  ...
  int maxTokens
      = 10; /* Initial array size, can be adjusted based on your needs */
 ...
 */
char *
strtok_custom (char *str, const char *delim)
{
